...
<section id="main-content">
    ...
    <div class="col-lg-10">
        <input class="form-control" id="tahun_masuk" name="tahun_masuk" type="number" min="1901" max="2155" required />
    </div>
</div>
...
<div class="form-group">
    ...
    <div class="col-lg-10">
        <input class="form-control" id="tahun_keluar" name="tahun_keluar" type="number" min="1901" max="2155" />
    </div>
</div>
